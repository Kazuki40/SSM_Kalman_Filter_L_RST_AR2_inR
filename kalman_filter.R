...
kf_function <- function(para) {
  ...
  if (AR_TorF == TRUE) {
    ans_ar <-
      iter_ar_distrubtion(parameter = para)
    state_error_P_f_t[9:system_state_vector_length, 9:system_state_vector_length] <-
      ans_ar
    state_error_P_a_t[9:system_state_vector_length, 9:system_state_vector_length] <-
      ans_ar
  }
  ...
  #design
  state_matrix_M <-
    system_model_design_matrix_M(sys_length = system_state_vector_length, parameter = para)
